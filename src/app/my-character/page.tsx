...
export default async function MyCharacterPage() {
  ...
  if (claimed.length > 1) {
    return (
      <div className="max-w-2xl mx-auto mt-12" style={{  }}>
        ...
        <div className="grid gap-3">
          {claimed.map((character) => (
            ...
            >
              <span className="font-semibold" style={{ color: '#e8eef7' }}>{character.name}</span>
  ...
  return (
    <div className="max-w-2xl mx-auto mt-16 text-center" style={{  }}>
      ...
      <p className="mb-8 text-base leading-7" style={{ color: '#9ca3af' }}>
        ...
        click <strong style={{ color: '#e8eef7' }}>Claim</strong> to link it to your account.
      </p>
      <Link
        href="/characters"
